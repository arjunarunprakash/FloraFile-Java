...
## User Stories:
- As a user, I want to be able to *add* plant life to my collection and *specify* the common name, species name, location(via dropdown meny), date, and observations. 
